...
public final class RunBerlinScenarioDiscreteModeChoiceBaseCase {

	private static final Logger log = Logger.getLogger(RunBerlinScenarioDiscreteModeChoiceBaseCase.class);
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			args = new String[]{"scenarios/homework2-1pct/input/berlin-v5.5-1pct.basecase.config.xml"};
		}
