...
sync: script-build
	...
	rsync --recursive --update --human-readable --verbose --partial --progress ${ARTIFACTS_DIR}${LOCAL_NAME}/ ${REMOTE}:${REMOTE_FOLDER_ROOT}artifacts/${NAME}
	rsync --update --human-readable --verbose --partial --progress ${ARTIFACTS_DIR}${LOCAL_NAME}.jar ${REMOTE}:${REMOTE_FOLDER_ROOT}artifacts/${NAME}.jar
